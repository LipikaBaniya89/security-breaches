...
setwd("~/Documents/ISA/Week 04/ch04/")
...
print(long2ip(ip2long("192.168.0.0")))
## [1] "192.168.0.0"
print(long2ip(ip2long("192.168.100.6")))
## [1] "192.168.100.6"
...
ggplot(combined.df, aes(x = reorder(Registry, -IANA.vs.AV.pct), y = IANA.vs.AV.pct)) +
  geom_bar(stat = "identity", fill = "gray") +
  coord_flip() +
  labs(title = "IANA - AV % Difference", x = "Registry", y = "% Difference") +
  theme_minimal()
